...
return [
    ...
    'profile_id' => env('paytabs_profile_id', 90173),
   ...
   */
    ...
    'server_key' => env('paytabs_server_key', 'SGJN2KL9NN-JD9KB96L9M-ZZZDMBB2TB'),
   ...
   */
    ...
    //'callback' => env('paytabs_ipn_callback', App\Http\Controllers\PaymentPage() ),
